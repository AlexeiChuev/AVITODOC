...
1.  **Скачайте клиент:** [Официальный сайт RustDesk](https://rustdesk.com/)
2.  **Настройте сеть:** В настройках программы выберите пункт «ID/Relay Server».
3.  **Введите данные:**
    * **ID Server:** `адрес.вашего.сервера`
    * **Key:** `ВАШ_ПУБЛИЧНЫЙ_КЛЮЧ`
4.  **Сообщите ID:** Передайте ваш сгенерированный ID специалисту для начала работы.
